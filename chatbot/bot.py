...
# load model
dtc , le  = pk.load(open('/Users\LakshmiReddy\Desktop\chatbot\chatbot_modelsave.unknown', 'rb'))
model,second_le  = pk.load(open('/Users\LakshmiReddy\Desktop\chatbot\chatbot_model.unknown', 'rb'))
...
FILE = "/Users\LakshmiReddy\Desktop\chatbot\data.pth"
...
# last answer 
def get_predicted_value(symptoms_experiance):
...
# print(get_pridected_value(['passage_of_gases', 'internal_itching']))


# get des precation 
def get_disease_predictions(dieses):
